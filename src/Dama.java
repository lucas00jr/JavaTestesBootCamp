...
public class Dama {
    ...
    public static void main(String[] args) {
        ...
        inteiros X1, Y1, X2 e Y2 (1 ≤ X1, Y1, X2, Y2 ≤ 8). A dama começa na casa de coordenadas (X1, Y1), e
        a casa de destino é a casa de coordenadas(X2, Y2). No tabuleiro, as colunas são numeradas da esquerda
        ...
        */
        ...
        while (true) {
            ...
            if (x1 == x2 && y1 == y2) { // Se o destino é o mesmo do incial
                System.out.println("0");

            } else if (x1 == x2 || y1 == y2) { //Se o movimento é horizontal ou vertical
                System.out.println("1");

            } else if ((x1 % 2 == 0 && y1 % 2 == 0) || (x1 % 2 != 0 && y1 % 2 != 0)) { //Diagonal
